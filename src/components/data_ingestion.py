...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df = pd.read_csv(os.path.join(BASE_DIR, 'data', "stud_perf.csv"))
            ...
            logging.info('There was an error during data ingestion!')
...
if __name__ == "__main__":
    ...
    r2_score, prediction = model_trainer.initiate_model_trainer(train_arr, test_arr)
